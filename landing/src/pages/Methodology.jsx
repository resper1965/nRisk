...
const FAQ_ITEMS = [
  { id: 1, question: "Como é calculado o score híbrido?", answer: "Combina score técnico (scan) e score declarativo (avaliação), ajustado pelo Fator de Confiança. Penalidade crítica aplica teto se houver achado crítico." },
  ...
  { id: 4, question: "O que é penalidade crítica?", answer: "Se existir qualquer achado de severidade crítica, o score final é limitado (teto), independentemente da avaliação. Garante visibilidade de risco extremo." },
  ...
  { id: 6, question: "Como funciona o histórico?", answer: "Cada avaliação gera um instantâneo. Antes/depois, justificativas aprovadas e evolução ficam registrados para tendência e prestação de contas." },
];
      ...
      <section className="border-b border-gray-800 px-4 py-16 sm:px-6 lg:py-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-lg text-gray-400">
            Score híbrido, conferência cruzada e histórico auditável.
          </p>
        </div>
      </section>
      ...
      <section className="scroll-mt-20 border-b border-gray-800 bg-gray-950 px-4 py-16 sm:px-6 lg:py-20">
        <div className="mx-auto max-w-6xl space-y-16">
          <div>
            ...
            <p className="mt-4 text-gray-400">Técnico (scan) + declarativo (avaliação) ajustado pelo Fator de Confiança. Categoria A–F.</p>
          </div>
          <div>

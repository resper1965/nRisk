    ...
    <section id={id} className="scroll-mt-20 border-b border-gray-800 bg-gray-850 px-4 py-16 sm:px-6 lg:py-24">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-4 text-gray-400">
          Converse com um especialista e veja como a n.Risk se aplica ao seu contexto.
        </p>
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center rounded-md border border-gray-600 bg-gray-800 px-5 py-2.5 text-sm font-medium text-gray-100 shadow-sm transition-smooth hover:bg-gray-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-accent"
          >
            Ver metodologia
          </Link>
        </div>
